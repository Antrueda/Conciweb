<?php
$controll='App\Http\Controllers\Asignafuncionario\AsignaFuncionario';
$routxxxx='asignafun';
Route::group(['prefix' => 'Asignafuncionario'], function () use($controll,$routxxxx){
	Route::get('', [
		'uses' => $controll.'Controller@index',
		'middleware' => ['permission:'.$routxxxx.'-leer|'.$routxxxx.'-crear|'.$routxxxx.'-editar|'.$routxxxx.'-borrar']
	])->name($routxxxx);
    Route::get('listaxxx', [
		'uses' => $controll.'Controller@listaUsers',
