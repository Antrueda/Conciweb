...
$controll='App\Http\Controllers\Administracion\AsuntoAdmin\AsignaDescripcion';
$routxxxx='asignadescri';
Route::group(['prefix' => 'AsignaDescripcion'], function () use($controll,$routxxxx){
	Route::get('', [
		'uses' => $controll.'Controller@index',
		'middleware' => ['permission:'.$routxxxx.'-leer|'.$routxxxx.'-crear|'.$routxxxx.'-editar|'.$routxxxx.'-borrar']
	])->name($routxxxx);
    Route::get('listaxxx', [
		'uses' => $controll.'Controller@listaAsignaDescripcion',
