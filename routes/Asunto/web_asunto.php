...
$controll='App\Http\Controllers\Administracion\AsuntoAdmin\Asunto';
$routxxxx='asunto';
Route::group(['prefix' => 'Asunto'], function () use($controll,$routxxxx){
	Route::get('', [
		'uses' => $controll.'Controller@index',
		'middleware' => ['permission:'.$routxxxx.'-leer|'.$routxxxx.'-crear|'.$routxxxx.'-editar|'.$routxxxx.'-borrar']
	])->name($routxxxx);
    Route::get('listaxxx', [
		'uses' => $controll.'Controller@listaAsunto',
