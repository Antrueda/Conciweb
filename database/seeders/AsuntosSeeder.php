...
class AsuntosSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     //   SubAsunto::create(['id' => 19, 'sis_esta_id' => 1, 'nombre' => 'ACOSO ESCOLAR (BULLYING).']);
        ...
        ASubasunto::create(['asunto_id' => 1, 'subasu_id' => 4]);
       ...
       // ASubasunto::create(['asunto_id' => 2, 'subasu_id' => 19]);
        ...
        Subdescripcion::create(['descri_id' => 3, 'subasu_id' => 20]);
        Subdescripcion::create(['descri_id' => 4, 'subasu_id' => 20]);
        ...
        Subdescripcion::create(['descri_id' => 6, 'subasu_id' => 21]);
        Subdescripcion::create(['descri_id' => 7, 'subasu_id' => 21]);
        Subdescripcion::create(['descri_id' => 8, 'subasu_id' => 21]);
        Subdescripcion::create(['descri_id' => 9, 'subasu_id' => 21]);
        Subdescripcion::create(['descri_id' => 10, 'subasu_id' => 21]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 22]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 22]);
        Subdescripcion::create(['descri_id' => 11, 'subasu_id' => 22]);
        Subdescripcion::create(['descri_id' => 12, 'subasu_id' => 22]);
        Subdescripcion::create(['descri_id' => 7, 'subasu_id' => 22]);
        Subdescripcion::create(['descri_id' => 8, 'subasu_id' => 22]);
        Subdescripcion::create(['descri_id' => 9, 'subasu_id' => 22]);
        Subdescripcion::create(['descri_id' => 10, 'subasu_id' => 22]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 23]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 23]);
        Subdescripcion::create(['descri_id' => 13, 'subasu_id' => 23]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 24]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 24]);
        Subdescripcion::create(['descri_id' => 13, 'subasu_id' => 24]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 25]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 25]);
        Subdescripcion::create(['descri_id' => 14, 'subasu_id' => 25]);
        Subdescripcion::create(['descri_id' => 15, 'subasu_id' => 25]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 26]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 26]);
        Subdescripcion::create(['descri_id' => 13, 'subasu_id' => 26]);
        Subdescripcion::create(['descri_id' => 16, 'subasu_id' => 26]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 27]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 27]);
        Subdescripcion::create(['descri_id' => 17, 'subasu_id' => 27]);
        Subdescripcion::create(['descri_id' => 16, 'subasu_id' => 27]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 28]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 28]);
        Subdescripcion::create(['descri_id' => 13, 'subasu_id' => 28]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 29]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 29]);
        Subdescripcion::create(['descri_id' => 18, 'subasu_id' => 29]);
        Subdescripcion::create(['descri_id' => 19, 'subasu_id' => 29]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 30]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 30]);
        Subdescripcion::create(['descri_id' => 18, 'subasu_id' => 30]);
        Subdescripcion::create(['descri_id' => 19, 'subasu_id' => 30]);
        Subdescripcion::create(['descri_id' => 20, 'subasu_id' => 30]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 31]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 31]);
        Subdescripcion::create(['descri_id' => 21, 'subasu_id' => 31]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 32]);
        Subdescripcion::create(['descri_id' => 5, 'subasu_id' => 32]);
        Subdescripcion::create(['descri_id' => 7, 'subasu_id' => 32]);
        Subdescripcion::create(['descri_id' => 8, 'subasu_id' => 32]);
        Subdescripcion::create(['descri_id' => 22, 'subasu_id' => 32]);
        Subdescripcion::create(['descri_id' => 23, 'subasu_id' => 32]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 1]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 1]);
        Subdescripcion::create(['descri_id' => 25, 'subasu_id' => 1]);
        Subdescripcion::create(['descri_id' => 26, 'subasu_id' => 1]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 2]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 2]);
        Subdescripcion::create(['descri_id' => 27, 'subasu_id' => 2]);
        Subdescripcion::create(['descri_id' => 28, 'subasu_id' => 2]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 3]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 3]);
        Subdescripcion::create(['descri_id' => 27, 'subasu_id' => 3]);
        Subdescripcion::create(['descri_id' => 29, 'subasu_id' => 3]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 4]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 4]);
        Subdescripcion::create(['descri_id' => 30, 'subasu_id' => 4]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 5]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 5]);
        Subdescripcion::create(['descri_id' => 29, 'subasu_id' => 5]);
        Subdescripcion::create(['descri_id' => 31, 'subasu_id' => 5]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 6]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 6]);
        Subdescripcion::create(['descri_id' => 32, 'subasu_id' => 6]);
        Subdescripcion::create(['descri_id' => 33, 'subasu_id' => 6]);
        Subdescripcion::create(['descri_id' => 34, 'subasu_id' => 6]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 7]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 7]);
        Subdescripcion::create(['descri_id' => 32, 'subasu_id' => 7]);
        Subdescripcion::create(['descri_id' => 35, 'subasu_id' => 7]);
        Subdescripcion::create(['descri_id' => 36, 'subasu_id' => 7]);
        Subdescripcion::create(['descri_id' => 37, 'subasu_id' => 7]);
        Subdescripcion::create(['descri_id' => 38, 'subasu_id' => 7]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 8]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 8]);
        Subdescripcion::create(['descri_id' => 29, 'subasu_id' => 8]);
        Subdescripcion::create(['descri_id' => 31, 'subasu_id' => 8]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 9]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 9]);
        Subdescripcion::create(['descri_id' => 39, 'subasu_id' => 9]);
        Subdescripcion::create(['descri_id' => 40, 'subasu_id' => 9]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 10]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 10]);
        Subdescripcion::create(['descri_id' => 41, 'subasu_id' => 10]);
        Subdescripcion::create(['descri_id' => 42, 'subasu_id' => 10]);
        Subdescripcion::create(['descri_id' => 43, 'subasu_id' => 10]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 11]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 11]);
        Subdescripcion::create(['descri_id' => 44, 'subasu_id' => 11]);
        Subdescripcion::create(['descri_id' => 45, 'subasu_id' => 11]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 12]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 12]);
        Subdescripcion::create(['descri_id' => 44, 'subasu_id' => 12]);
        Subdescripcion::create(['descri_id' => 46, 'subasu_id' => 12]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 13]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 13]);
        Subdescripcion::create(['descri_id' => 47, 'subasu_id' => 13]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 14]);
        Subdescripcion::create(['descri_id' => 48, 'subasu_id' => 14]);
        Subdescripcion::create(['descri_id' => 49, 'subasu_id' => 14]);
        Subdescripcion::create(['descri_id' => 50, 'subasu_id' => 14]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 15]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 15]);
        Subdescripcion::create(['descri_id' => 28, 'subasu_id' => 15]);
        Subdescripcion::create(['descri_id' => 51, 'subasu_id' => 15]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 16]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 16]);
        Subdescripcion::create(['descri_id' => 28, 'subasu_id' => 16]);
        Subdescripcion::create(['descri_id' => 51, 'subasu_id' => 16]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 17]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 17]);
        Subdescripcion::create(['descri_id' => 28, 'subasu_id' => 17]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 18]);
        Subdescripcion::create(['descri_id' => 48, 'subasu_id' => 18]);
        Subdescripcion::create(['descri_id' => 52, 'subasu_id' => 18]);
        Subdescripcion::create(['descri_id' => 1, 'subasu_id' => 33]);
        Subdescripcion::create(['descri_id' => 24, 'subasu_id' => 33]);
