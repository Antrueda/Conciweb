...
class TextosSeeder extends Seeder
{
    ...
    public function run()
    {
         Texto::create(['texto'=>'<p>Si su solicitud de conciliación está relacionada con asuntos de naturaleza laboral, contratos de prestación de servicios (honorarios), simulación o están involucradas entidades del estado, 
         se invita a abstenerse de adelantar su solicitud, ya que, el Centro de Conciliación y MASC de Personería de Bogotá DC <b>NO TIENE COMPETENCIA</b> para conocerla y su solicitud será Inadmitida</p>
