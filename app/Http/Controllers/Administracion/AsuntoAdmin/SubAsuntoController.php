...
use App\Traits\Administracion\Asunto\SubAsunto\CrudTrait;
use App\Traits\Administracion\Asunto\SubAsunto\DataTablesTrait;
use App\Traits\Administracion\Asunto\SubAsunto\ParametrizarTrait;
use App\Traits\Administracion\Asunto\SubAsunto\VistasTrait;
 ...
 */
class SubAsuntoController extends Controller
{
    ...
    {
        $this->opciones['permisox'] = 'subasunto';
        $this->opciones['routxxxx'] = 'subasunto';
        $this->getOpciones();
    ...
    public function store(SubAsuntoRequest $request)
    {
    ...
    public function show(SubAsunto $modeloxx)
    {
    ...
    public function edit(SubAsunto $modeloxx)
    {
        $this->opciones['pestania'] = $this->getPestanias($this->opciones);
    ...
    public function update(SubAsuntoRequest $request,  SubAsunto $modeloxx)
    {
        return $this->setSubAsunto([
            'requestx' => $request,
            'modeloxx' => $modeloxx,
    ...
    public function destroy(Request $request, SubAsunto $modeloxx)
    {
    ...
    public function activate(SubAsunto $modeloxx)
    {
        $this->opciones['pestania'] = $this->getPestanias($this->opciones);
        return $this->view(
    ...
    public function activar(Request $request, SubAsunto $modeloxx)
    {
