        ...
        <table width="100%" class="table">
            ...
            <tr>
                <td style="text-align: justify;" colspan="3">
                    ...
                    @empty(!$datosApoderado)
                        @foreach ($datosApoderado as $infoCon)
                            <b>{!! $infoCon->apoderado !!}.</b>&nbsp;
                        @endforeach
                    Mediante petición radicada en la fecha indicada en el asunto,
                    @endempty
                    @empty(!$datosApoderado)
                        actuando como apoderado del(a) Sr(a)
                    @endempty
                    @empty($datosApoderado)
                        el(a) Sr(a)
                    @endempty
                        ...
                        @endforeach
                    presento(aron) una solicitud con el fin de celebrar una audiencia de conciliación,
