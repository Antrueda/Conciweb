    ...
    <div class="container" style="background-color: white">
            ...
            <div class="card-header" id="headingOne">
                <div class="row">
                    <div class="col-md-2 text-right">
                        <img src="{{URL::asset('imagen/logo.png')}}" width="150px" height="50px" class="img-fluid" alt="">
                    </div>
                        ...
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded" aria-labelledby="navbarDropdown">
                                    <small>
                                        <a class="dropdown-item" href="#"><img src="{{URL::asset('imagen/depend2.svg')}}" width="30px" height="30px"> -&nbsp;&nbsp; <strong>{{Session::get('nombreSede')}}</strong></a>
        ...
        <div class="card-footer text-muted">
            ...
            <ul class="list-group list-group-horizontal-sm">
                <li class="list-group-item">Concilaiciones <small class="text-muted"> V 3.0.0 </small></li>
