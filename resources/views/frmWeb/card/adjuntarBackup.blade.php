        ...
        <p>
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <ul class="list-group">
                <li class="list-group-item">TODOS los soportes que anexe, debe adjuntarlos en formato PDF y en tamaño oficio.</li>
                ...
                <li class="list-group-item">El sistema CONCIWEB después de recibir la información registrada por usted, enviará una notificación al correo electrónico; 
                  ...
                  <li class="list-group-item">Es OBLIGATORIO diligenciar el formato 05-FR-40, el cual se encuentra a continuación.</li>
              </ul>
            </div>
