        ...
        <div class="card-body" style="margin-bottom: 40px;">
            <div class="row">
                <div class="col-md-6">
                    ...
                    {{ Form::select('tipoDocumento', $data['listaTipoDoc'], null, ['class' => $errors->first('tipoDocumento') ? 'form-select form-select-sm is-invalid' : 'form-select form-select-sm validate[required]'.'required','id'=>'tipoDocumento']) }}
