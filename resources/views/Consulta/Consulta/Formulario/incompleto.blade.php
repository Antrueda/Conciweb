...
<br><p style="width:90%;margin:auto;" class="alert alert-warning"><i class="fa-regular fa-circle-check fa-2xl"></i>' . '<span style="padding:8px;font-size: 1.2rem;"> El proceso no ha terminado</span></p><br>
<div class="row">
  <div class="col-md-12">
