...
<br><p style="width:90%;margin:auto;" class="alert alert-success"><i class="fa-regular fa-circle-check fa-2xl"></i><span style="padding:8px;font-size: 1.2rem;"> El proceso de adjuntar documentos finalizó el día {{$Dfinalizacion}} </span></p><br>
<div class="row">
  <div class="col-md-12">
