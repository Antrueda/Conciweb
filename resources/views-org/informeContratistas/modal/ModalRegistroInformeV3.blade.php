                ...
                <form name="frmRegistroInforme" id="frmRegistroInforme" method="POST" enctype="multipart/form-data"  onKeyPress="return disableEnterKey(event)" onsubmit="return false;">
                    ...
                    <!-- INICIA SECCIO DATOS BASICOS CONTRATO-JEFE-FECHAS -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <label class="form-group has-float-label">
                                    <input class="form-control form-control validate[required]" type="text" name="numContrato" id="numContrato" autocomplete="off" value="{{ $data['numContrato']}}" readonly>
                                    <span>6. Número de contrato   *</span>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label class="form-group has-float-label">
                                    <input class="form-control form-control validate[required]" type="text" name="vigenciaContrato" id="vigenciaContrato" autocomplete="off" value="{{ $data['vigenciaContrato']}}" readonly>
...
<script>
    ...
    function envioDatosRegistroPermisos(){
        $.ajax({
            type: "POST",
            url: "/registroInformeEjecucionV3",
            dataType: 'text',
